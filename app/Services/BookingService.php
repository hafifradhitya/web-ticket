...
class BookingService {
    ...
    public function paymentStore(array $validated)
    {
        ...
        DB::transaction(function() use ($validated, &$bookingTransactionId, $booking, &$newBooking) {
        ...
        // Kirim email ke user setelah transaksi berhasil
        if ($newBooking) {
            Mail::to($newBooking->email)->send(new OrderConfirmed($newBooking));
        }
